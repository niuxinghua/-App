...
#define BACKGROUND_STAR_IMAGE_NAME @"stargray"
...
- (void)buildDataAndUI {
    ...
    self.foregroundStarView = [self createStarViewWithImage:@"star"];
    self.backgroundStarView = [self createStarViewWithImage:@"stargray"];
